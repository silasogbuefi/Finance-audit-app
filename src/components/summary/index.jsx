        ...
        <Flex w={'full'}
            ...
            <Flex flex={1}
                 ...
                 mr={'2'}>
                    ...
                    <Flex justifyContent={'space-evenly'} alignItems={'center'} bg={'gray.50'} w={'full'} h={'100px'}
                        border={'1px solid'}
            ...
            <Box flex={1} mt={'10'} ml={'-90px'} mr={'5'} w={'300px'} height={'300px'} display={'flex'} alignItems={'center'} justifyContent={'center'}>
                <Heading>
